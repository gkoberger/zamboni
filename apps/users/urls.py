...
users_patterns = patterns('',
    ...
    url('^delete(?:/(?P<user_id>\d+))?$', views.admin_delete,
    ...
    url(r'^complete-profile-form$', views.complete_profile_form,
        name='users.complete_profile_form'),
    url(r'^complete-profile\.json$', views.complete_profile,
